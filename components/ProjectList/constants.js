export const workProjects = [
  ...
  export const selfMadeProjects = [
    ...
    { name: "TributePage", 
      ...
      description: "The Tribute Page project is a responsive web-based project that displays a tribute page using HTML and CSS. The project is designed to be accessible and user-friendly on all devices."
    },
  ];

  export const javaScript = [
    { name: "Background Colorchanger", 
      url: "/javaScript/BackgroundColorChanger/index.html",
      description: "The Background Color Changer project is an interactive web-based project that allows users to change the background color of the page using JavaScript. The project is designed to be user-friendly and accessible."
    },
    { name: "CalorieCounter", 
      url: "/javaScript/CalorieCounter/index.html",
      description: "The Calorie Counter project is an interactive web-based project that allows users to count their daily calorie intake using JavaScript. The project is designed to be user-friendly and accessible."
    },
    { name: "GradeHelp", 
    ...
    { name: "PyramidBuilding", 
      ...
      description: "The Pyramid Building project is an interactive web-based project that allows users to build a pyramid using JavaScript. The project is designed to be user-friendly and accessible."
    },
  ];